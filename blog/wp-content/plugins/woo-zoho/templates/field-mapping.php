...
<div class="vxc_fields vxc_field_value" style="<?php if($this->post2($k,'type',$map) != 'value'){echo 'display:none';} ?>">
<input type="text" name='meta[map][<?php echo esc_attr($k)?>][value]'  id="vx_value_<?php echo esc_attr($k) ?>" value='<?php echo $this->post2($k,'value',$map)?>' placeholder='<?php esc_html_e("Custom Value",'woo-zoho')?>' class='vx_input_100 vxc_field_input'>
...
<div class="vxc_fields vxc_field_value" style="display:none">
<input type="text" name="value"  value="" placeholder='<?php esc_html_e("Custom Value",'woo-zoho')?>' class='vx_input_100 vxc_field_input'>
<div class="howto"><?php echo sprintf(__('You can add a form field %s in custom value from following form fields','woo-zoho'),'<code>{field_id}</code>')?></div>
</div>
