...
$fields=array(); $req=array('contact_name'); $dates=array('date','start_date','end_date','shipment_date'); $bool=array('is_discount_before_tax','is_taxable');
...
$egs=array('reference_invoice_type'=>'registered');
...
if(in_array($module,array('Sales_Orders','Purchase_Orders','Invoices','Quotes'))){
    ...
    if($module == 'Invoices'){ $field_name='Invoiced_Items';  }else if($module == 'Quotes'){ $field_name='Quoted_Items';  }
...
if(method_exists($item,'get_product')){
  ...
  $temp=array('sku'=>$sku,'unit_price'=>$unit_price,'title'=>wp_strip_all_tags($title),'qty'=>$qty,'tax'=>$tax,'total'=>$total,'cost'=>$cost,'cost_woo'=>$cost_woo,'qty_stock'=>$stock,'img_id'=>$img_id,'cat'=>$cat,'tax_id'=>'');
          if(method_exists($product,'get_stock_quantity')){
...
public function get_zoho_products($meta){ 
 ...
 $product_detail=array('price'=>$unit_price,'qty'=>$qty,'tax_id'=>$tax_id,'total'=>$total,'cost'=>$cost,'cost_woo'=>$cost_woo);
...
public function client_info(){
  ...
  $secret=array('eu'=>'f659dba19a084551da0d3d34080ac4b06b23e5b976','in'=>'09e03e8e5ead546bbd8932368cf8b2d0a9fdda2f7e','jp'=>'60e9ea26cbd5650a0fe86f0acee29962be0f1dd938','uk'=>'f12e7ce4603798e289326a2184c90e212026505438');
...
//var_dump($body,$header,$path,$response);
