...
<!-- Minimum Requirement -->
<section class="wrapper mt-12 mt-sm-16 d-none" >
    <div class=" container card image-wrapper bg-full bg-image bg-overlay bg-overlay-300 p-6 " style="background-image:url('{{asset('')}}images/background/company_registration_bg.jpg')" >
      ...
      <div class="card-body p-4 p-xl-4">
        <div class="row align-items-center gy-4 text-start text-sm-center text-white">
          <div class="col-12 col-lg-6">
            <p class="fs-18">Minimum number of 2 Shareholders</p>
          </div>
          <!--/column -->
          <div class="col-12 col-lg-6">
            <p class="fs-18">Minimum number of 2 Directors</p>
          </div>
          <!--/column -->
          <div class="col-12 col-lg-6">
            <p class="fs-18">One of the Director must be Indian Resident</p>
          </div>
          <!--/column -->
          <div class="col-12 col-lg-6">
            <p class="fs-18">Registered Office must be of Indian address</p>
          </div>
          <!--/column -->
        </div>
        <!--/.row -->
      ...
      <div class="card ">
        <div class="row">
          <div class="col-lg-6 p-sm-8 p-4 capsule-section">
              ...
              <ul class="row px-6 d-none">
                <li class="mt-2">Digital signature for 2 directors</li>
                <li class="mt-2">DIN for 2 directors</li>
                <li class="mt-2">Incorporation certificate of the company</li>
                <li class="mt-2">Company TAN card</li>
                <li class="mt-2">Company PAN card</li>
                <li class="mt-2">Memorandum of Association</li>
                <li class="mt-2">Articles of Association</li>
                <li class="mt-2">Bank account opening support</li>
                <li class="mt-2">ESIC & EPF number</li>
              </ul>
          </div>
          <!--/column -->
...
.trustpilot-rating-list .trustpilot-rating-list-item .trustpilot-rating-img{
    margin-bottom:20px;
}
.trustpilot-rating-list .trustpilot-rating-list-item .trustpilot-rating-img img{
  width: 175px !important;
}
</style>

@php
$app_trustpilot_link = 'https://www.trustpilot.com/review/juststart.co.in';
@endphp

<section class="wrapper mt-12 mt-sm-12 bg-pale-blue mb-10 trustpilot-rating-list" style="background-color: #f2f3fa !important;">
  <div class="container pt-10 pb-10">
      <div class="row">
          <div class="col-lg-12 p-sm-8 p-4 ">
            <h2 class="display-5 font-bolder text-center ">
              What Our <span class="text-blue">Client Says</span> 
            </h2>
          </div>
      </div>
      <div class="card trustpilot-rating-list-item">
        <div class="row p-5 ">
          <div class="col-lg-12 ">
              <figure class="trustpilot-rating-img">
                <img src="{{asset('')}}images/service-icon/trustpilot-stars-5-rating.svg" />
              </figure>

              <p class="review-text">
              In this company, you can believe in pure stars. Because I shared the documents for the process of company formation on 21st March and on 23rd Navneet ji gave me my PAN, TAN & CIN number. I got all the work done with very little expense. Thank you so much Juststart
              </p>

              <div class="d-flex flex-row reviewer-name-img">
                <div class="reviewer-img">
                  <figure class="rounded me-5">
                      <img src="{{asset('')}}images/trust-pilot-user/anurag-uttam.webp" />
                    </figure>
                </div>
                <div>
                  <h4 class="mb-1 reviewer-name">
                    <a href="{{$app_trustpilot_link}}">Anurag Uttram</a>
                  </h4>
                  <p class="mb-0 reviewer-posted-on">Posted on <a href="{{$app_trustpilot_link}}">TrustPilot</a></p>
                </div>
              </div>
          </div>
        </div>
      ...
      <div class="card mt-10 trustpilot-rating-list-item">
        <div class="row p-5 ">
          <div class="col-lg-12 ">
              <figure class="trustpilot-rating-img">
                <img src="{{asset('')}}images/service-icon/trustpilot-stars-5-rating.svg" />
              ...
              <div class="d-flex flex-row reviewer-name-img">
                <div class="reviewer-img">
                  <figure class="rounded me-5">
                      <img src="{{asset('')}}images/trust-pilot-user/tushar-tyagi.webp" />
                    </figure>
                </div>
                <div>
                  <h4 class="mb-1 reviewer-name">
                    <a href="{{$app_trustpilot_link}}">Tushar Tyagi</a>
                  </h4>
                  <p class="mb-0 reviewer-posted-on">Posted on <a href="{{$app_trustpilot_link}}">TrustPilot</a></p>
                </div>
              </div>
        ...
        <div class="row p-5 ">
          <div class="col-lg-12 ">
              ...
              <div class="d-flex flex-row reviewer-name-img">
                <div class="reviewer-img">
                  <figure class="rounded me-5">
                      <img src="{{asset('')}}images/trust-pilot-user/binay.webp" />
                    </figure>
                </div>
                <div>
                  <h4 class="mb-1 reviewer-name">
                    <a href="{{$app_trustpilot_link}}">Binay Bhattacharya</a>
                  </h4>
                  <p class="mb-0 reviewer-posted-on">Posted on <a href="{{$app_trustpilot_link}}">TrustPilot</a></p>
                </div>
              </div>
      ...
      <div class="card mt-10 trustpilot-rating-list-item">
        <div class="row p-5 ">
          <div class="col-lg-12 ">
              ...
              <p class="review-text">
              This my 2nd time when I filled TM application through juststart and the support person Santosh Tiwari who helped and guide through the successful application of TM registration. Waiting for passing my application now. Thanks Santosh Tiwari.
              </p>

              <div class="d-flex flex-row reviewer-name-img">
                <div class="reviewer-img">
                  <figure class="rounded me-5">
                      <img src="{{asset('')}}images/trust-pilot-user/fitwithrb.webp" alt="Fitwithrb" />
                    </figure>
                </div>
                <div>
                  <h4 class="mb-1 reviewer-name">
                    <a href="{{$app_trustpilot_link}}">Fit With RB</a>
                  </h4>
                  <p class="mb-0 reviewer-posted-on">Posted on <a href="{{$app_trustpilot_link}}">TrustPilot</a></p>
                </div>
              </div>
        ...
        <div class="row p-5 ">
          <div class="col-lg-12 ">
              ...
              <div class="d-flex flex-row reviewer-name-img">
                <div class="reviewer-img">
                  <figure class="rounded me-5">
                      <img src="{{asset('')}}images/trust-pilot-user/dhruv-joshi.webp" />
                    </figure>
                </div>
                <div>
                  <h4 class="mb-1 reviewer-name">
                    <a href="{{$app_trustpilot_link}}">Dhruv Joshi</a>
                  </h4>
                  <p class="mb-0 reviewer-posted-on">Posted on <a href="{{$app_trustpilot_link}}">TrustPilot</a></p>
                </div>
              </div>
        ...
        <div class="row p-5 ">
          <div class="col-lg-12 ">
              ...
              <div class="d-flex flex-row reviewer-name-img">
                <div class="reviewer-img">
                  <figure class="rounded me-5">
                      <img src="{{asset('')}}images/trust-pilot-user/ashish-krishnan.webp" />
                    </figure>
                </div>
                <div>
                  <h4 class="mb-1 reviewer-name">
                    <a href="{{$app_trustpilot_link}}">Aasish Krishnan Vt</a>
                  </h4>
                  <p class="mb-0 reviewer-posted-on">Posted on <a href="{{$app_trustpilot_link}}">TrustPilot</a></p>
                </div>
              </div>
