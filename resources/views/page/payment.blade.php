        ...
        <div class="blog single mt-n17">
          <div class="card shadow-lg">
            <div class="card-body">
              ...
              <p class="text-center mb-6"><a href="https://pages.razorpay.com/pl_KCx5OvAOsM1Atv/view" class="btn btn-sm btn-outline-primary rounded-pill">Click To Pay Online</a></p>
